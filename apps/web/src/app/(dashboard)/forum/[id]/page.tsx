...
export default function ForumPostPage() {
  ...
  const submitReply = async (e: React.FormEvent) => {
    ...
    if (res.ok) {
      ...
      // Note: Backend doesn't return full user object in simple reply create, 
      // but we'll mock it for immediate UI feedback or just refetch
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={submitReply} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2rem] p-6 shadow-sm space-y-4">
          <textarea
            ...
            className="w-full bg-zinc-50 dark:bg-zinc-950 border-none rounded-xl p-4 min-h-[100px] outline-none focus:ring-2 focus:ring-blue-500 text-sm transition-all"
          />
